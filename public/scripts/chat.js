...
{
	var messageContainer = $('#chat-message');
	messageContainer.append('<div style="margin-top: 5px; background-color: #efefef; box-shadow: 1px 1px 1px 1px gray;padding: 10px"><div style="font-weight:bold; display: inline-block">' + data.sender + ':</div><div style="display: inline-block; word-break: break-all"><img style="max-width: 100%" src=\"' + data.message + '"/></div><div style="color: gray; margin-top: 5px; text-align: right">'+data.sentOn+'</div></div>');
	messageContainer.scrollTop(messageContainer.prop("scrollHeight"));
});
